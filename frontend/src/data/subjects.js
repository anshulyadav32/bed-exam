    ...
    gk: {
        ...
        sections: [
            ...
            },
            {
                ...
                explanation: "India's Constitution — the longest written constitution in the world — is the core of this chapter. Study Fundamental Rights (Part III, Articles 12–35), the three-tier government structure, and Panchayati Raj (73rd Amendment, 1992). Article numbers for Fundamental Rights, emergency provisions (352, 356, 360), and the five writs are frequently tested."
            },
            {
    ...
    reasoning: {
        ...
        sections: [
            ...
            },
            {
                ...
                explanation: "Analytical reasoning focuses on logical deduction through syllogisms, statement-conclusion pairs, and spatial puzzles. Use Venn diagrams for syllogisms and draw ranking lists for comparison puzzles. Seating arrangements (linear and circular) typically carry 5–8 marks and are very scoring with regular practice."
            },
            {
        ...
        sections: [
            {
                ...
                explanation: "This chapter covers the core of effective teaching — methods (lecture, discussion, demonstration, project, problem-solving), Bloom's revised taxonomy, lesson planning frameworks (Herbart's 5 steps), and classroom communication styles. Bloom's taxonomy levels and Herbart's 5-step sequence are the most frequently tested items."
            },
            {
            ...
            },
            {
                ...
                explanation: "Effective classroom management covers proactive time management, inclusive education principles (RTE Act 2009, Salamanca Statement, UDL), student behavior strategies (positive reinforcement, assertive discipline), and assessment techniques. The distinction between formative and summative assessment and the CCE evaluation pattern are high-priority exam topics."
            }
        ],
        examPattern: {
            totalQuestions: "15-20",
