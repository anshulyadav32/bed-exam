...
const SUBJECTS_DATA = [
    {
        ...
        examTotalQuestions: "15-25",
        examType: "Multiple Choice Questions (MCQs)",
        examDifficulty: "Easy to Moderate",
        sections: [
            {
    ...
    },
    {
        id: "reasoning",
        name: "🧠 Reasoning",
        description: "Logic, series, analogies",
        color: "#1a5a51",
    ...
    },
    {
        ...
        description: "Teaching methods, psychology",
        color: "#165a52",
